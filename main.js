const companies= [
    ...
    {name: "company five",category: "retail",start:1987,end:20011},
...
const ages=[33,12,45,35,23,24,5,66,77,46,54];
...
//const canDrink=ages.filter(function(age){
  //  if(age>=21){
    ...
    //}
//});
const canDrink=ages.filter(age => 21);
...
//const agesquared =ages.map(ages=> Math.sqrt(ages));
//const agetimestwo=ages.map(ages=>ages*2);
